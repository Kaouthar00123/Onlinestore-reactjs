...
export default function SearchComponent() {
  return (
    <form class="flex items-center max-w-sm mx-auto">
      ...
      <button
        type="submit"
        class="p-2.5 ms-2 text-sm font-medium text-white bg-gray-600 rounded-lg border border-gray-600 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
      >
        <svg
          class="w-4 h-4"
          aria-hidden="true"
